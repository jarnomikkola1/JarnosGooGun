...
namespace JarnosGooGun
{
	...
	/// </summary>
	public class JarnosGooGunMain : ModMain
	{ 
		...
		public new JarnosGooGunConfig Config => (JarnosGooGunConfig)base.Config;
		public override bool CanSafelyDisable => true;
		public JarnosGooGunMain Main { get; private set; }
        ...
        internal static SharedDamageKeywordsDataDef keywords = GameUtl.GameComponent<SharedData>().SharedDamageKeywords; //JarnoTweaksMain.keywords;
        ...
        public override void OnConfigChanged() {
            ...
            DefRepository defRepository2 = GameUtl.GameComponent<DefRepository>();

            //this is new
            if (Config.maxgoo == true)
			{
                WeaponDef CannonDef = (WeaponDef)defRepository2.GetDef("290b7f59-2dba-99a4-aaad-c410e64b6af2"); // <- Goo cannon
                CannonDef.DamagePayload.DamageKeywords[0].Value = 20f; //damage
